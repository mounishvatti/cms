        ...
        <form>
            <div className="grid gap-6 p-8">
                <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-border">
                    <span className="relative z-10 bg-green-800 rounded-full text-white/80 font-bold text-lg py-2 px-4">
                        + Add a new course
                    </span>
                </div>
                <div className="grid gap-6">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Button
                            ...
                            className="w-min justify-center items-center bg-black/20 border border-slate-400 hover:bg-slate-700/40"
                        >
                    ...
                    <Button
                        ...
                        className="w-min justify-center items-center bg-green-900 hover:bg-green-700/40 border border-green-500 text-green-100 font-bold"
                    >
                        Add course
                    </Button>
                </div>
